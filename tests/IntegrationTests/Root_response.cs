...
public class Root_response : BaseIntegrationTests
{
    ...
    {
        Assert.Equal("/api/contentapi/employee", rootRequestResponse["_links"]!.Value<string>("employee"));
    }

    [Fact]
    public void Has_scrumteam_href()
    {
        Assert.Equal("/api/contentapi/scrumteam", rootRequestResponse["_links"]!.Value<string>("scrumteam"));
    }

    [Fact]
    public void Has_project_href()
    {
        Assert.Equal("/api/contentapi/project", rootRequestResponse["_links"]!.Value<string>("project"));
    }
